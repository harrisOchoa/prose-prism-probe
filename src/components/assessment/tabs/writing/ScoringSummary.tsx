...
const ScoringSummary: React.FC<ScoringSummaryProps> = ({
  ...
  return (
    <div className="w-full">
      <div
        className={`grid grid-cols-1 md:grid-cols-[auto_1fr] items-stretch w-full rounded-xl border shadow-sm ${getScoreBgColor(overallWritingScore)} bg-white/90`}
      >
        {/* Left: Score & Rating */}
        <div className="flex flex-row items-center justify-start gap-8 px-7 py-7 md:py-10 border-b md:border-b-0 md:border-r min-w-[280px] md:max-w-[350px]">
          ...
          <div className="flex flex-col pl-6 border-l h-full">
