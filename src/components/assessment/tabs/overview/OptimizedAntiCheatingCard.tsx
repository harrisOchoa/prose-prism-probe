...
interface OptimizedAntiCheatingCardProps {
  metrics: AntiCheatingMetricsType | undefined;
}

const OptimizedAntiCheatingCard: React.FC<OptimizedAntiCheatingCardProps> = memo(({ metrics }) => {
  ...
  return shallowEqual(prevProps.metrics, nextProps.metrics);
});

OptimizedAntiCheatingCard.displayName = "OptimizedAntiCheatingCard";

export default OptimizedAntiCheatingCard;
